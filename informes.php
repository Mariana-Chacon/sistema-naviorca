...
<table>
  ...
  <tbody>
  <?php
  $sql = "SELECT informenes.*, informe_id, informacion_informe, nombre_personal, fecha_inicio, fecha_finalizacion, tipo_equipo.nombre AS tipo_equipo, marca_equipo, modelo_equipo, serial_equipo, descripcion_asignacion, orden_id
  FROM informenes
  INNER JOIN tipo_equipo ON tipo_equipo = tipo_equipo";
