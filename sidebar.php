...
<a href="mantenimiento.php"   onclick="showCategory()" ><img width="30" height="30" src="https://img.icons8.com/color/30/water-transportation.png" alt="water-transportation"/>Mantenimiento</a>
...
<a href="configuraciones.php"   onclick="showProductItems()" ><img width="30" height="30" src="https://img.icons8.com/color/30/settings--v1.png" alt="settings--v1"/>Configuraciones</a>
   <!---->
</div>
